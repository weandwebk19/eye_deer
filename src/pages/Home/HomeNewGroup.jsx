...
import { StyledInputField, customTheme } from 'components/Textbox/StyledInputField';
...
export default function HomeNewGroup() {
  ...
  const onSubmit = async (groupInfo) => {
    selectedFile ? groupInfo.picture = selectedFile : groupInfo.picture = null;
  ...
  return (
    <div>
        <StyledPrimaryButton className="add-group-button" onClick={handleClickOpen}>
            + new group
        </StyledPrimaryButton>
              ...
              >
                ...
                >
                  <Grid
                    ...
                    xs={12}
                  >
                    <img src={preview || pictureDefault} alt="picture group" style={{width: "100%", height: "100%"}}/>
                  </Grid>
                  <Grid
                    item
                    xs={12}
                  ...
                  >
                    <StyledInputField
                      ...
                      {...register("name", {
                        ...
                        minLength:1,
                        maxLength: 20,
                        pattern: {value: /^([A-Za-z0-9 ]{1,15})$/i, message: "1 - 15 characters!"},
                      },
                      )}
                    />
                    {errors.name ? (
            ...
            <DialogActions>
              ...
              >
                <Grid
                  ...
                  sm={6}
                >
                  <StyledPrimaryButton fullWidth type="submit">Add</StyledPrimaryButton>
                </Grid>
                <Grid
                  item
                  xs={12}
                  sm={6}
                >
                  <StyledSecondaryButton fullWidth onClick={handleClose}>Cancel</StyledSecondaryButton>
                </Grid>
              </Grid>
            </DialogActions>
          </form>
